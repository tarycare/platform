 ...
 * Version: 1.3.0
 * Description: Manage Form Members
 * Text-Domain: forms
 * GitHub Plugin URI: tarycare/forms
 * GitHub Plugin URI: https://github.com/tarycare/forms
 */
...
$config = [
    'plugin_name'          => 'Forms',               // Plugin Name
    'plugin_slug'          => 'forms',               // Plugin Slug
    'menu_title_en'        => 'Forms',               // English Menu Title
    'menu_title_ar'        => 'النماذج',                   // Arabic Menu Title
    'capability'           => 'read',                      // Capability Required
    'icon'                 => 'dashicons-forms',          // Menu Icon
    'position'             => 1,                           // Menu Position
    'app_script_handle'    => 'form-react-app',      // Script Handle
    'app_script_dev'       => 'http://localhost:3000/apps/forms/dist/forms.js',  // Dev Script URL
    'app_style_dev'        => 'http://localhost:3000/apps/forms/assets/style.css',              // Dev Style URL
    'app_script_prod'      => 'dist/forms.js',        // Prod Script Path
    'app_style_prod'       => '../assets/style.css',       // Prod Style Path
    'dynamic_id'           => 'forms',   // Dynamic ID for React App Container
    'path_constant'        => 'PATH_Forms',                    // Dynamic Path Constant
    'url_constant'         => 'URL_Forms',                     // Dynamic URL Constant
    'class_name'           => 'Form_Admin_Page',     // Dynamic Class Name
];
